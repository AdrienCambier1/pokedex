...
export default function Header() {
  ...
  return (
    <header className="w-full border-b border-white dark:border-zinc-700 dark:bg-zinc-900 bg-white shadow h-16 flex fixed z-50 items-center justify-between px-6">
